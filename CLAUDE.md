...
- **Trial early-morning classes (Nicholas starts school 8/13, freeing up earlier mornings):** Mon 8:45 BODYCOMBAT, Tue 9:00 BODYPUMP, Thu 9:00 BODYPUMP — all Southwest. None of the three should start before **8/17**; the pause calendar handles this naturally for Mon/Tue (first live occurrence lands 8/17/8/18), and 8/13 is explicitly paused for `bodypump-thu` (except-ing the existing Cycle Sculpt) so its first live occurrence is 8/20. Check in after a few weeks on whether to keep them.
